...
export const EarningScreen: React.FC = () => {
  ...
  const earningTransactions = getTransactionsByType('earning');
  const earningCategories = getCategoriesByType('earning');
  ...
  const openAddModal = () => {
    ...
    setSelectedCategory(earningCategories[0]?.id || '');
    setAmount('');
    setItemName('');
    setDescription('');
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.header}>
        <Text style={[styles.headerTitle, { color: colors.text }]}>Earning</Text>
        <Text style={[styles.headerSubtitle, { color: colors.textSecondary }]}>
          {earningTransactions.length} transactions
        </Text>
      </View>
          ...
          <View style={[styles.modalContent, { backgroundColor: colors.surface }]}>
            <ScrollView showsVerticalScrollIndicator={false}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>
                {editingTransaction ? 'Edit Transaction' : 'Add Earning'}
              </Text>
